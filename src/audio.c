...
char *tracks[13] = {"/switch/meritous/dat/m/ICEFRONT.S3M",
					"/switch/meritous/dat/m/cavern.xm",
					"/switch/meritous/dat/m/cave.xm",
					"/switch/meritous/dat/m/cave06.s3m",
					"/switch/meritous/dat/m/Wood.s3m",
					"/switch/meritous/dat/m/iller_knarkloader_final.xm",
					"/switch/meritous/dat/m/fear2.mod",
					"/switch/meritous/dat/m/Cv_boss.mod",
					"/switch/meritous/dat/m/Fr_boss.mod",
					"/switch/meritous/dat/m/CT_BOSS.MOD",
					"/switch/meritous/dat/m/rpg_bat1.xm",
					"/switch/meritous/dat/m/amblight.xm",
					"/switch/meritous/dat/m/FINALBAT.s3m"};
...
void CircuitHum()
{
	...
	if (magic_circuit > 0) {
		...
		if (hum_play != 1) {
			...
			c_sample[0] = Mix_LoadWAV("/switch/meritous/dat/a/circuitcharge.wav");
	...
	if (magic_circuit < 0) {
		...
		if (hum_play != 2) {
			...
			c_sample[0] = Mix_LoadWAV("/switch/meritous/dat/a/circuitrecover.wav");
			Mix_PlayChannel(0, c_sample[0], -1);
			hum_play = 2;
		}
	}
...
{
	SND_Play("/switch/meritous/dat/a/circuitrelease.wav", sqrt(str * 2 + (str * 5300 / circuit_size) + (str > 100 ? 5300 : str*53)));
}
