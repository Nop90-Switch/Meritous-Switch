...
void ShowEnding()
{
	...
	if (streamspr == NULL) {
		streamspr = IMG_Load("/switch/meritous/dat/i/stream.png");
		SDL_SetColorKey(streamspr, SDL_SRCCOLORKEY | SDL_RLEACCEL, 0);
		glitter = IMG_Load("/switch/meritous/dat/i/glitter.png");
	...
	Paint(0, 0, 22, 27, "/switch/meritous/dat/d/cstream.loc");
...
void DrawCredits()
{
	...
	if (fin == NULL) {
		fin = IMG_Load("/switch/meritous/dat/i/fin.png");
		
		theend[0] = IMG_Load("/switch/meritous/dat/i/theend.png");
		theend[1] = IMG_Load("/switch/meritous/dat/i/true_end.png");
	}
...
void DrawCircuitFlash(int t, int method)
{
	...
	if (circ == NULL) {
		circ = IMG_Load("/switch/meritous/dat/i/circuits_1.png");
	}
